...
const PROMPT_TEXT =
  ...
  + 'Use window_send to deliver instructions: default queues as follow-up; steer: true '
  + 'injects at the next step boundary; interrupt: true aborts a stuck tool call and '
  + 'delivers immediately (use when a child is blocked in a long-running call). '
