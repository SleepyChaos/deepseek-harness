...
export type AgentPresetSettingsKey =
  ...
  | 'presetConcurrentName' | 'presetConcurrentDescription'
...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  presetConcurrentName: 'Concurrent mode',
  presetConcurrentDescription:
    'Scheduling agent that runs a task queue through child window sessions with bounded parallelism and ability upgrades.',
  duplicate: 'Duplicate',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  presetConcurrentName: '并发模式',
  presetConcurrentDescription: '通过子窗口会话并行处理题目队列，支持并发预算、能力梯度升级与批次回收的调度 Agent。',
  duplicate: '复制',
...
const BUILT_IN_PRESET_KEYS: Readonly<Partial<Record<string, PresetLocaleKeys>>> = {
  ...
  concurrent: { name: 'presetConcurrentName', description: 'presetConcurrentDescription' },
}
