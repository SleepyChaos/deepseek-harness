...
Requires: `tools` · `systemPrompt` · `agents` · `llm` · `sessionQuery` · `agentPresets`
...
Source: [`packages/session/window-session/src/index.ts:47`](../packages/session/window-session/src/index.ts)
